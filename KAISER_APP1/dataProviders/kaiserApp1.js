...
(function() {
    var provider = app.data.kaiserApp1 = new Everlive({
            offlineStorage: true,
            appId: 'ok21luesp37m8e35',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'kaiserApp1_access_token',
...
// START_CUSTOM_CODE_kaiserApp1
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_kaiserApp1